...
abstract class MetadataModule {
    ...
    companion object {
        ...
        @PerActivity
        @JvmStatic
        internal fun providePresenter(view: MetadataView, repository: SampleRepository, remoteStorage: RemoteStorage): MetadataPresenter=
            MetadataPresenter(view, repository, remoteStorage)
    }
}
